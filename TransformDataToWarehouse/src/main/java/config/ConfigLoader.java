...
public class ConfigLoader {
    ...
    private static final int DB_STAGING_TYPE = 1;
    ...
    public DatabaseConnection loadStagingDBConfig() {
        JsonObject jsonResult = loadJsonFromJar();
        if (jsonResult == null) {
            return null;
        }
        return extractJsonResultToDatabaseConnection(jsonResult, DB_STAGING_TYPE);
    }
